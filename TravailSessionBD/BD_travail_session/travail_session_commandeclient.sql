...
CREATE TABLE `commandeclient` (
  ...
  CONSTRAINT `commandeclient_ibfk_1` FOREIGN KEY (`id_client`) REFERENCES `client` (`id_client`)
...
LOCK TABLES `commandeclient` WRITE;
/*!40000 ALTER TABLE `commandeclient` DISABLE KEYS */;
/*!40000 ALTER TABLE `commandeclient` ENABLE KEYS */;
UNLOCK TABLES;
