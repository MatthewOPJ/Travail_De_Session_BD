...
LOCK TABLES `produitbrut` WRITE;
/*!40000 ALTER TABLE `produitbrut` DISABLE KEYS */;
INSERT INTO `produitbrut` VALUES (1,'Oeux',20,'g',0.49);
/*!40000 ALTER TABLE `produitbrut` ENABLE KEYS */;
UNLOCK TABLES;
