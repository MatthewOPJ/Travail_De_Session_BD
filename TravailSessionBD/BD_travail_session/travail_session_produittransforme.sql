...
DROP TABLE IF EXISTS `produittransforme`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `produittransforme` (
  `id_produit_transforme` int NOT NULL AUTO_INCREMENT,
  `nom` varchar(100) DEFAULT NULL,
  `quantite_stock` int DEFAULT NULL,
  `unite_mesure` varchar(50) DEFAULT NULL,
  `commentaire` text,
  PRIMARY KEY (`id_produit_transforme`)
...
LOCK TABLES `produittransforme` WRITE;
/*!40000 ALTER TABLE `produittransforme` DISABLE KEYS */;
/*!40000 ALTER TABLE `produittransforme` ENABLE KEYS */;
UNLOCK TABLES;
