...
DROP TABLE IF EXISTS `productionplanifiee`;
...
CREATE TABLE `productionplanifiee` (
  ...
  CONSTRAINT `productionplanifiee_ibfk_1` FOREIGN KEY (`id_produit_transforme`) REFERENCES `produittransforme` (`id_produit_transforme`)
...
LOCK TABLES `productionplanifiee` WRITE;
/*!40000 ALTER TABLE `productionplanifiee` DISABLE KEYS */;
/*!40000 ALTER TABLE `productionplanifiee` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-03 15:48:45
