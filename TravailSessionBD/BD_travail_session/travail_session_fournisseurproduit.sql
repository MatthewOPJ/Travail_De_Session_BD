...
CREATE TABLE `fournisseurproduit` (
  ...
  PRIMARY KEY (`id_fournisseur`,`id_produit_brut`),
  KEY `id_produit_brut` (`id_produit_brut`),
  CONSTRAINT `fournisseurproduit_ibfk_1` FOREIGN KEY (`id_fournisseur`) REFERENCES `fournisseur` (`id_fournisseur`) ON DELETE CASCADE,
  CONSTRAINT `fournisseurproduit_ibfk_2` FOREIGN KEY (`id_produit_brut`) REFERENCES `produitbrut` (`id_produit_brut`) ON DELETE CASCADE
