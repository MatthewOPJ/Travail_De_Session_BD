        ...
        <form>
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="client" placeholder="Thomas Beaulieu">
            </div>

            <div class="col-md-6">
              <label for="produit" class="form-label">Produit commandé</label>
              <select class="form-select" id="produit">
                <option selected>Choisir un produit...</option>
                <option>Choucroute nature 500 g</option>
                <option>Kimchi traditionnel 500 g</option>
                <option>Cornichons à l’aneth 1 L</option>
                <option>Betteraves lacto-fermentées 500 g</option>
              </select>
            </div>

            <div class="col-md-4">
              <label for="quantite" class="form-label">Quantité</label>
              <input type="number" class="form-control" id="quantite" placeholder="Ex. 20">
            </div>
        ...
        <table class="table table-bordered align-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Kimchi traditionnel 500 g</td>
              <td>36 unités</td>
            ...
            <tr>
              <td>19 mai 2024</td>
              <td>Café du Coin</td>
              <td>Cornichons à l’aneth 1 L</td>
              <td>24 unités</td>
              <td><span class="badge bg-primary">Expédiée</span></td>
              <td>
                <button class="btn btn-sm btn-warning me-1" data-bs-toggle="modal" data-bs-target="#modifierModal">
                  <i class="bi bi-pencil-square"></i>
                </button>
            ...
            <tr>
              <td>18 mai 2024</td>
              <td>Bistro Local</td>
              <td>Betteraves lacto-fermentées 500 g</td>
              <td>30 unités</td>
